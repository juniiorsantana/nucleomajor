...
/**
 * O painel da plataforma, que só o administrador do Núcleo Major enxerga:
...
const { AdministracaoPlataforma } = await import("./Configuracoes");
...
async function montar() {
  ...
  await act(async () => raiz.render(<AdministracaoPlataforma />));
  await act(async () => {});
}

...
/**
 * A administração do Núcleo Major saiu daqui em 24/09/2026 e foi para o painel
 * da plataforma (painel.nucleomajor.com): liberação manual, vendas do Asaas,
 * pedidos de WhatsApp e os interruptores de cada empresa. Aqui fica só a
 * porta, e só para quem é da administração — cliente nenhum precisa saber que
 * o painel existe.
 */
export function enderecoDoPainel() {
  const configurado = globalThis.__NUCLEO_CONFIG__?.painelOrigin;
  return String(configurado || "https://painel.nucleomajor.com").replace(/\/$/, "");
}

export function AtalhoDoPainel() {
  ...
  return (
    <Bloco
      ...
      descricao="Liberar acesso, vendas do Asaas, pedidos de WhatsApp, prazos, planos e as funções de cada empresa ficam no painel da plataforma."
      acao={
        <a
